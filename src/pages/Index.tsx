        ...
        <div className="max-w-4xl mx-auto text-center space-y-12">
          ...
          <div className="space-y-6">
            <h1 className="text-4xl md:text-5xl font-bold text-mitsubishi-gray">
              Welcome to <span className="text-primary">Mitsubishi Motors</span>
            </h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Secure and efficient visitor registration system. Register your visit with our 
              QR code scanner or manual form entry.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            <div className="text-center space-y-4">
              ...
              <h3 className="text-lg font-semibold text-mitsubishi-gray">QR Code Scanner</h3>
              <p className="text-muted-foreground">
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-lg font-semibold text-mitsubishi-gray">Secure Process</h3>
              <p className="text-muted-foreground">
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-lg font-semibold text-mitsubishi-gray">Professional Experience</h3>
              <p className="text-muted-foreground">
